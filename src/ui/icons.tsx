...
/** Toolbar: sound is on — click to mute. Lucide `volume-2`. */
export function Volume2Icon(props: SVGProps<SVGSVGElement>) {
  return (
    <Icon data-lucide="volume-2" {...props}>
...
/** Toolbar: sound is muted — click to unmute. Lucide `volume-x`. */
export function VolumeXIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <Icon data-lucide="volume-x" {...props}>
      <path d="M11 4.702a.705.705 0 0 0-1.203-.498L6.413 7.587A1.4 1.4 0 0 1 5.416 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.416a1.4 1.4 0 0 1 .997.413l3.383 3.384A.705.705 0 0 0 11 19.298z" />
